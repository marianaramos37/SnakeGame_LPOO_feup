...
public class ArenaTest {
    ...
    public void setAndGetTopScoreTest() throws IOException {
        ...
        singlePlayerTopScore.setFilename("src/main/java/com/g44/files/testTopScore.txt");
    ...
    public void testFileConstructor() throws IOException {
        ArenaModel arena = new ArenaModel(50, 50,"src/main/java/com/g44/files/mapMedium.txt");
