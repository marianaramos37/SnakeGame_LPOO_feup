...
public class GameThread extends Thread{
    ...
    public GameThread(ArenaController cntr){
        ...
        snake=cntr.getSnakeController();
        scoreController=cntr.getScoreController();
    }
        ...
        try {
            ...
            while (true) {
                ...
                if (!arena.getGameOver()) {
                    arenaController.checkCollisions(arena.getSnake().getPosition(), arena);
